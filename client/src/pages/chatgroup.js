...
let socket;
const CONNECTION_PORT = "https://garfield-network.herokuapp.com";
...
const Chatgroup = (props) => {
  ...
  const connectToRoom = () => {
    ...
    axios
      .get(`https://garfield-network.herokuapp.com/api/getRoomMessage?room=${room}`)
  ...
  const sendMessage = async () => {
    ...
    axios
      .post("https://garfield-network.herokuapp.com/api/rooms", msgm)
